...
```
sudo wget https://raw.githubusercontent.com/ShaheenHossain/install_script_19/install_script_ent_1965/odoo_install_cmt_1965.sh
```
sudo chmod +x odoo_install_cmt_1965.sh
```
sudo ./odoo_install_cmt_1965.sh
```
