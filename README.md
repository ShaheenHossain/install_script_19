...
```
sudo wget https://raw.githubusercontent.com/ShaheenHossain/install_script_19/install_niir_websys_ent_1969/odoo_install_ent_1969.sh
```
sudo chmod +x odoo_install_ent_1969.sh
```
sudo ./odoo_install_ent_1969.sh
```
